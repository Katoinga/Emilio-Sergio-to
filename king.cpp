...
void King::move()
{
    ...
    QString team = this->getSide();
        ...
        if(col > 0 && row > 0 && !(core->collection[row-1][col-1]->getChessPieceColor() == team)) {//up left
        ...
        if(col < 7 && row > 0 && !(core->collection[row-1][col+1]->getChessPieceColor() == team)) { // up right
            location.append(core->collection[row-1][col+1]);
            core->collection[row-1][col+1]->setColor(Qt::darkRed);
            if(location.last()->getHasChessPiece()){
                location.last()->setColor(Qt::red);
        ...
        if(row>0 && !(core->collection[row-1][col]->getChessPieceColor() == team)) {//up
        ...
        if(row<7 && !(core->collection[row+1][col]->getChessPieceColor() == team)) {//down
            location.append(core->collection[row+1][col]);
            core->collection[row+1][col]->setColor(Qt::darkRed);
            if(location.last()->getHasChessPiece()){
                location.last()->setColor(Qt::red);
        ...
        if(col>0 && !(core->collection[row][col-1]->getChessPieceColor() == team)) {// left
        ...
        if(col<7 && !(core->collection[row][col+1]->getChessPieceColor() == team)) {//right
            location.append(core->collection[row][col+1]);
            core->collection[row][col+1]->setColor(Qt::darkRed);
            if(location.last()->getHasChessPiece()){
                location.last()->setColor(Qt::red);
        ...
        if(col > 0 && row < 7  && !(core->collection[row+1][col-1]->getChessPieceColor() == team)) {//down left
            location.append(core->collection[row+1][col-1]);
            core->collection[row+1][col-1]->setColor(Qt::darkRed);
            if(location.last()->getHasChessPiece()){
                location.last()->setColor(Qt::red);
        ...
        if(col < 7 && row < 7 && !(core->collection[row+1][col+1]->getChessPieceColor() == team)) {//down right
            location.append(core->collection[row+1][col+1]);
            core->collection[row+1][col+1]->setColor(Qt::darkRed);
            if(location.last()->getHasChessPiece()){
                location.last()->setColor(Qt::red);
